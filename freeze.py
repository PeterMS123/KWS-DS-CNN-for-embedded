...
def create_inference_graph(wanted_words, sample_rate, clip_duration_ms,
  ...
  print(net_c1)
  conv1 = tf.convert_to_tensor(net_c1, dtype=tf.float32, name='conv1_vals')
  print(fingerprint_4d)
  fin = tf.convert_to_tensor(fingerprint_4d, dtype=tf.float32, name='log_mel')
...
def main(_):
  ...
  create_inference_graph(FLAGS.wanted_words, FLAGS.sample_rate,
                         ...
                         FLAGS.input_type, FLAGS.model_size_info)
