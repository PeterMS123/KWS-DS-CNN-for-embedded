...
#ifndef KWS_LOG_MEL_H
#define KWS_LOG_MEL_H
...
#define LOG_MEL_BUFFER_SIZE (NUM_FRAMES*NUM_FBANK_BINS)
...
class LOG_MEL{
  ...
  public:
    LOG_MEL();
    ~LOG_MEL();
    void log_mel_compute(const int16_t* data, uint16_t dec_bits, int8_t* log_mel_out);
};
