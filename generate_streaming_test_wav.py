...
def main(_):
  ...
  model_settings = models.prepare_model_settings(
      ...
      FLAGS.window_size_ms, FLAGS.window_stride_ms, FLAGS.dct_coefficient_count, activation_bits)
  audio_processor = input_data.AudioProcessor(
      '', FLAGS.data_dir, FLAGS.silence_percentage, 10,
      FLAGS.wanted_words.split(','), FLAGS.validation_percentage,
      FLAGS.testing_percentage, model_settings, FLAGS.input_type)
  ...
  print('Total number of words: '+ str(how_many_words))
  for i in range(how_many_words):
    if(i%50 == 0):
        print(str(i)+'/'+str(how_many_words))
    output_offset = (
